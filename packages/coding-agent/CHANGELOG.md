...
- Fixed accepted questionnaire custom answers continuing to display their generic “Other” labels.
- Restored Enter as a multi-select toggle while retaining Space as an equivalent control.
